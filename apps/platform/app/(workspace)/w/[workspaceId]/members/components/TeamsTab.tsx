...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, Button, Input, Label, toast, Card, Combobox, type ComboboxOption } from '@biffco/ui'
  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in duration-300">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold text-text-primary">Agrupaciones y Roles</h2>
        ...
        {isLoadingTeams || isLoadingMembers ? (
          ...
          <Card key={team.id} className="bg-surface border border-border overflow-hidden flex flex-col shadow-sm">
            <div className="p-5 border-b border-border flex justify-between items-start bg-surface">
              ...
              <button onClick={() => handleDelete(team.id)} className="text-text-muted hover:text-error transition-colors">
                 <IconTrash size={18} />
              </button>
            </div>
