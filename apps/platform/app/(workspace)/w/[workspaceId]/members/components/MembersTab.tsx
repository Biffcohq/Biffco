  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-text-primary">Directorio de Miembros</h2>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <form onSubmit={handleInvite} className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="email" className="text-slate-900">Correo electrónico</Label>
                <Input 
                  id="email" 
                  type="email"
              ...
              <div className="grid gap-2">
                <Label htmlFor="role" className="text-slate-900">Rol asignado</Label>
                <select 
                  id="role"
                  className="flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50"
                  value={inviteRole}
        ...
        <div className="p-4 border-b border-border border-dashed bg-surface-raised flex items-center justify-between gap-4">
          <div className="relative w-full max-w-sm">
            ...
            <input 
              ...
              className="w-full bg-surface border border-border text-sm rounded-md pl-9 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-primary/50 text-text-primary transition-all placeholder:text-text-muted"
            />
          </div>
