...
const connectionString = config_1.env.DATABASE_URL || "postgresql://biffco:biffco_pass@localhost:5432/biffco";
const queryClient = (0, postgres_1.default)(connectionString);
exports.db = (0, postgres_js_1.drizzle)(queryClient, { schema, logger: config_1.env.NODE_ENV === "development" });
